export type PreferredView = 'publisher' | 'creator';
export type NullablePreferredView = PreferredView | null;
...
export type ApplicationStatus =
  ...
  | 'withdrawn'
  | 'completed';
export type AccountStatus = 'normal' | 'watchlist' | 'restricted_publish' | 'restricted_apply' | 'banned';
...
export const COOPERATION_PLATFORM_OPTIONS = [
...
export const COOPERATION_CATEGORY_OPTIONS = [
...
export const FOLLOWER_BAND_OPTIONS = [
...
export const PREFERRED_VIEW_LABELS: Record<PreferredView, string> = {
  publisher: '发布方',
  creator: '达人',
};
