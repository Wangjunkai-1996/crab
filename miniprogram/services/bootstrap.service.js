...
function prepareBootstrapRuntime() {
    const runtimeSwitchState = (0, cloud_1.initCloud)();
...
async function switchBootstrapRuntime(mode, cloudEnvId = (0, runtime_config_1.getCloudEnvId)()) {
